...
substituindo $r = D/2$, obtemos
$$ G = \frac{32 \pi I_0}{D^{2} a} = 1685632.5261933 \pi I $$

$$ \Delta G = \sqrt{\frac{1024 \pi^{2} {\Delta I_0}^{2}}{D^{4} a^{2}} + \frac{1024 \pi^{2} {\Delta a}^{2} {I_0}^{2}}{D^{4} a^{4}} + \frac{4096 \pi^{2} {\Delta D}^{2} {I_0}^{2}}{D^{6} a^{2}}} $$
